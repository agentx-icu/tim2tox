...
void main() {
  group('Self Query Tests (Virtual)', () {
    ...
    test('Friend list query with multiple friends', () async {
      ...
      try {
        ...
        // Wait for friends to appear in Alice's list via virtual-clock pump.
        // Inline pump loop because predicate is async. Test tolerates 0/1/2
        // friends in its assertions, so a 6s budget is sufficient — friend
        // P2P bring-up over loopback typically converges in <2s.
        final deadline = VirtualClock.nowMs + 6000;
        var converged = false;
