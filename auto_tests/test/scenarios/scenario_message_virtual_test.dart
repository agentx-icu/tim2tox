/// Message Test — virtual-clock variant
///
/// Mirrors scenario_message_test.dart 1:1 but drives the harness via the
...
void main() {
  group('Message Tests (Virtual)', () {
    ...
    setUpAll(() async {
      ...
      // spawns inside V2TIMManagerImpl::InitSDK.
      ...
      // Idempotent on test_mode but seeds the virtual clock.
    ...
    test('Message query', () async {
      ...
      // Wait for message to be processed and stored (virtual)
