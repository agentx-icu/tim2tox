// Group State Test — virtual-clock variant
//
// Mirrors scenario_group_state_test.dart 1:1 but drives the harness via
...
void main() {
  group('Group State Tests (Virtual)', () {
