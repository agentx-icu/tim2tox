...
class Tim2ToxSdkPlatform extends TencentCloudChatSdkPlatform {
      ...
      if (chatMsg.isSelf && !isPending) {
        ...
        if (chatMsg.isSelf && forwardTargetID != null && v2Msg.msgID != null) {
          ...
          for (final entry in _forwardMessageCache.entries) {
            ...
            final keyMatches = entry.key == v2MsgID || entry.key == v2Id;
  ...
  bool _recentlyNotifiedQuitGroup(String groupID) {
    ...
    _recentQuitNotifyMs.removeWhere((_, ts) => now - ts > _quitNotifyDedupMs);
      ...
      case GlobalCallbackType.ConversationEvent:
        {
          ...
          if (convEvent == '2' && resultList.isNotEmpty) {
            ...
            try {
              ...
              _logListenerError('ConversationEvent.parse', e, st);
            }
            if (conversationList.isNotEmpty) {
              ...
              for (final l in convList) {
                try {
                  ...
                  _logListenerError(
                      'V2TimConversationListener.onConversationChanged', e, st);
                }
              }
            }
          }
          ...
          if (jsonUserInfoValue != null) {
            ...
            for (final l in sdkList) {
              try {
                ...
                _logListenerError('V2TimSDKListener.onSelfInfoUpdated', e, st);
              }
            }
          }
        }
          ...
          if (v != null) {
            ...
            for (final l in sdkList) {
              try {
                ...
                _logListenerError('V2TimSDKListener.onUserInfoChanged', e, st);
              }
            }
          }
        }
            ...
            if (messageArray.isNotEmpty) {
              ...
              Future.microtask(() async {
                ...
                try {
                  final conversationId = v2Msg.groupID ?? v2Msg.userID ?? '';
                  if (conversationId.isNotEmpty) {
                    final chatMsg = MessageConverter.v2TimMessageToChatMessage(
            ...
            case GroupTipsElemType.V2TIM_GROUP_TIPS_TYPE_QUIT:
              ...
              for (final l in grpList) {
                try {
                  ...
                  _logListenerError('V2TimGroupListener.onMemberLeave', e, st);
                }
              }
              break;
        ...
        if (parsed is Map) {
          ...
          if (!chatMsg.isSelf && senderTimestampMs != null) {
            ...
            try {
              ...
              await ffiService.messageHistoryPersistence.loadHistory(convId);
            } catch (_) {
